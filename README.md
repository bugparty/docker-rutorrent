...
# [bowmanhan/rutorrent](https://github.com/bugparty/docker-rutorrent)
...
```
git clone https://github.com/bugparty/docker-rutorrent.git
cd docker-rutorrent
docker build \
  --no-cache \
  --pull \
  -t bowmanhan/ruturrent:latest .
```
...
* **06.07.22:** - update rutorrent to 0.9.8/0.13.8 for the people are too lazy to migrate, new image address https://github.com/bugparty/docker-rutorrent
